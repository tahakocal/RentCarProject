...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void CarManagerTest()
        {
            ...
            {
                Id = 1, BrandId = 1, CarName = "Nissan", Description = "Nissan R34", ColorId = 5, ModelYear = 2001,
                DailyPrice = 500
            });
            carManager.Add(new Car
            {
                Id = 2, BrandId = 1, CarName = "BMW", Description = "BMW M4", ColorId = 1, ModelYear = 2020, DailyPrice = 0
            });
            carManager.Add(new Car
            {
